...
*
*/
	Configure::write('Actor.dbFile', ROOT.'/'.APP_DIR.'/tmp/actors.json');
	Configure::write('Actor.fieldsFile', ROOT.'/'.APP_DIR.'/tmp/fields.json');
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvxFDS4gnasdf');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '123123123123123123');
